...
export const tools: { name: ToolType; icon: any; color: string; bg: string }[] = [
  ...
  { name: 'JPG to SVG', icon: Image, color: 'text-emerald-600', bg: 'bg-emerald-100' },
  { name: 'EXCEL to PDF', icon: FileText, color: 'text-red-500', bg: 'bg-red-100' },
  { name: 'JPG to WEBP', icon: Image, color: 'text-blue-500', bg: 'bg-blue-100' },
  { name: 'HEIC to JPG', icon: Image, color: 'text-blue-600', bg: 'bg-blue-100' },
  ...
  { name: 'JFIF to JPG', icon: Image, color: 'text-green-700', bg: 'bg-green-100' },
  { name: 'SVG to JPG', icon: FileCode, color: 'text-orange-500', bg: 'bg-orange-100' },
  { name: 'JPG to WORD', icon: FileText, color: 'text-blue-600', bg: 'bg-blue-100' },
  { name: 'PDF to EXCEL', icon: FileSpreadsheet, color: 'text-emerald-700', bg: 'bg-emerald-100' },
  { name: 'WEBP to JPG', icon: Image, color: 'text-purple-600', bg: 'bg-purple-100' },
  { name: 'EXCEL to JPG', icon: FileSpreadsheet, color: 'text-blue-500', bg: 'bg-blue-100' },
  { name: 'JPG to PNG', icon: Image, color: 'text-cyan-600', bg: 'bg-cyan-100' },
  { name: 'CSV to EXCEL', icon: FileSpreadsheet, color: 'text-blue-600', bg: 'bg-blue-100' },
